...
public class ToolTrimSmithingTemplate {
    ...
    public static final Identifier EMPTY_SLOT_BOW_TEXTURE = new Identifier(MOD_ID, "item/gui/empty_slot_bow");
    public static final Identifier EMPTY_SLOT_CROSSBOW_TEXTURE = new Identifier(MOD_ID, "item/gui/empty_slot_crossbow");
